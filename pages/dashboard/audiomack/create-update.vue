...
export default {
  ...
  methods: {
    async fetchData() {
      if (this.$route.query.id) {
        const response = await fetch(
          `/api/dashboard/audiomack-ads/${this.$route.query.id}`,
          {
            method: "GET",
            headers: {
    ...
    async submitForm() {
      if (this.is_update) {
        await fetch(`/api/dashboard/audiomack-ads/${this.$route.query.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Cookie: document.cookie,
        ...
        await fetch("/api/dashboard/audiomack-ads/create", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Cookie: document.cookie,
      ...
      this.$router.push({ name: "dashboard-audiomack" });
    },
    reset() {
